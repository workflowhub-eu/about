...
Make sure that all the metadata you filled in previously is showed properly and is correct.  Workflow Hub generates an RO-crate based on these files and the metadata you filled in while registering the workflow.
